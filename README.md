...
```json
"dependencies": { "chip-freq": "github:drf5n/Wokwi-Chip-L298N@1.0.1" }
```
...
The actual source code for the chip lives in [src/main.c](https://github.com/drf5na/Wokwi-Chip-L298N/blob/main/src/main.c), and the pins are described in [chip.json](https://github.com/drf5na/Wokwi-Chip-L298N/blob/main/chip.json).
